  ...
  if (!user && !loading) {
    return (
      <div className="max-w-lg mx-auto mt-16 p-6 border rounded">
        ...
        <p className="mb-4">
          You must be logged in or register to redeem this invite link.
        </p>
        <div className="flex flex-col gap-6">
          ...
          >
            ...
            >
              {regLoading ? "Registering..." : "Register & Join Event"}
            </button>
    ...
    <div className="max-w-lg mx-auto mt-16 p-6 border rounded">
      {loading ? (
        ...
        <>
          ...
          <div className="mb-2">
            You are about to join as a <b>Reporter</b>.
          </div>
          {invite && (
            <div className="mb-4 text-sm text-gray-700">
              <div>
                <b>Invite Note:</b> {invite.note || "—"}
              </div>
              <div>
                <b>Expires:</b>{" "}
                {invite.expiresAt
              ...
              <div>
                <b>Uses:</b> {invite.useCount}
                {invite.maxUses ? ` / ${invite.maxUses}` : ""}
              </div>
              <div>
                <b>Status:</b> {invite.disabled ? "Disabled" : "Active"}
              </div>
            </div>
          )}
          {success ? (

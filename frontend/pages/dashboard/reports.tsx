  ...
  return (
    <div className="min-h-screen bg-background py-8 px-4 transition-colors duration-200">
      <Card className="w-full max-w-4xl mx-auto p-4 sm:p-8">
        ...
        <p className="text-muted-foreground">Cross-event report viewing is coming soon.</p>
        <p className="text-sm text-muted-foreground mt-2">This will show all reports across your events with filtering and search capabilities.</p>
      </Card>
    </div>
  );
} 
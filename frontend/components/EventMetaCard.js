      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-6 mb-4">
          ...
          {showEdit && (editingField === "logo" ? (
            <div className="absolute top-0 left-0 w-24 h-24 flex flex-col items-center justify-center bg-white/80 dark:bg-gray-900/80 rounded z-10 p-2">
              ...
              <div className="flex gap-1 mt-2">
                <button type="button" onClick={onEditSave} className="text-green-600" aria-label="Save logo" disabled={logoUploadLoading}><CheckIcon className="h-4 w-4" /></button>
                <button type="button" onClick={onEditCancel} className="text-gray-500" aria-label="Cancel edit" disabled={logoUploadLoading}><XMarkIcon className="h-4 w-4" /></button>
              </div>
              {logoUploadLoading && <span className="text-xs text-gray-500 mt-1">Uploading...</span>}
            </div>
          ) : (
            <button type="button" onClick={() => onEditStart && onEditStart("logo", event.logo)} className="absolute top-1 right-1 text-blue-600 bg-white dark:bg-gray-900 rounded-full p-1 shadow" aria-label="Edit logo"><PencilIcon className="h-5 w-5" /></button>
          ))}
        </div>
        <div className="flex-1">
            ...
            {showEdit && editingField === "name" ? (
              <>
                <input
                  ...
                  style={{ minWidth: 120 }}
                />
                <button type="button" onClick={onEditSave} className="text-green-600" aria-label="Save event name"><CheckIcon className="h-5 w-5" /></button>
                <button type="button" onClick={onEditCancel} className="text-gray-500" aria-label="Cancel edit"><XMarkIcon className="h-5 w-5" /></button>
              </>
            ) : (
              <>
                <h1 className="text-2xl font-bold">{event.name}</h1>
                {showEdit && (
                  <button type="button" onClick={() => onEditStart && onEditStart("name", event.name)} className="text-blue-600" aria-label="Edit event name"><PencilIcon className="h-5 w-5" /></button>
                )}
              </>
            )}
          </div>
            ...
            <span className="flex items-center gap-1">
              ...
              {showEdit && editingField === "startDate" ? (
                <>
                  ...
                  />
                  <button type="button" onClick={onEditSave} className="text-green-600 ml-1" aria-label="Save start date"><CheckIcon className="h-4 w-4" /></button>
                  <button type="button" onClick={onEditCancel} className="text-gray-500 ml-1" aria-label="Cancel edit"><XMarkIcon className="h-4 w-4" /></button>
                </>
              ) : (
                <>
                  {event.startDate ? new Date(event.startDate).toLocaleDateString() : <span className="italic text-gray-400">(none)</span>}
                  {showEdit && (
                    <button type="button" onClick={() => onEditStart && onEditStart("startDate", event.startDate)} className="text-blue-600 ml-1" aria-label="Edit start date"><PencilIcon className="h-4 w-4" /></button>
                  )}
                </>
              )}
            </span>
              ...
              {showEdit && editingField === "endDate" ? (
                <>
                  <input
                    ...
                    className="px-2 py-1 rounded border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 text-sm"
                  />
                  <button type="button" onClick={onEditSave} className="text-green-600 ml-1" aria-label="Save end date"><CheckIcon className="h-4 w-4" /></button>
                  <button type="button" onClick={onEditCancel} className="text-gray-500 ml-1" aria-label="Cancel edit"><XMarkIcon className="h-4 w-4" /></button>
                </>
              ) : (
                <>
                  ...
                  {showEdit && (
                    <button type="button" onClick={() => onEditStart && onEditStart("endDate", event.endDate)} className="text-blue-600 ml-1" aria-label="Edit end date"><PencilIcon className="h-4 w-4" /></button>
                  )}
                </>
              )}
            </span>
            <span className="flex items-center gap-1">
              ...
              {showEdit && editingField === "website" ? (
                <>
                  ...
                  />
                  <button type="button" onClick={onEditSave} className="text-green-600 ml-1" aria-label="Save website"><CheckIcon className="h-4 w-4" /></button>
                  <button type="button" onClick={onEditCancel} className="text-gray-500 ml-1" aria-label="Cancel edit"><XMarkIcon className="h-4 w-4" /></button>
                </>
              ) : (
                <>
                  ...
                  {showEdit && (
                    <button type="button" onClick={() => onEditStart && onEditStart("website", event.website)} className="text-blue-600 ml-1" aria-label="Edit website"><PencilIcon className="h-4 w-4" /></button>
                  )}
                </>
              )}
            </span>
          ...
          <div className="flex items-center gap-2 mb-2">
            ...
            {showEdit && editingField === "description" ? (
              <>
                <textarea
                  ...
                  style={{ minWidth: 180 }}
                />
                <button type="button" onClick={onEditSave} className="ml-2 text-green-600" aria-label="Save description"><CheckIcon className="h-5 w-5" /></button>
                <button type="button" onClick={onEditCancel} className="ml-1 text-gray-500" aria-label="Cancel edit"><XMarkIcon className="h-5 w-5" /></button>
              </>
            ) : (
            ...
            {showEdit && (
              <button type="button" onClick={() => onEditStart && onEditStart("description", event.description)} className="ml-2 text-blue-600" aria-label="Edit description"><PencilIcon className="h-5 w-5" /></button>
            )}
          </div>
          {/* Code of Conduct */}
          <div className="flex items-center gap-2 mb-2">
            ...
            {showCodeButton && (
              <button onClick={() => setShowCodeModal && setShowCodeModal(true)} className="text-blue-600 dark:text-blue-400 underline font-medium">View Code of Conduct</button>
            )}
            {showEdit && (
              <button type="button" onClick={() => onEditStart && onEditStart("codeOfConduct", event.codeOfConduct)} className="ml-2 text-blue-600" aria-label="Edit code of conduct"><PencilIcon className="h-5 w-5" /></button>
            )}
          </div>
